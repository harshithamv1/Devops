...
WebUI.verifyElementText(findTestObject('Object Repository/Page_OrangeHRM/a_Welcome Admin'), 'Welcome Admin')

WebUI.closeBrowser()

WebUI.callTestCase(findTestCase('Day1/TestCase1_Record'), [:], FailureHandling.STOP_ON_FAILURE)
