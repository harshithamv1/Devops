...
WebUI.verifyTextNotPresent('Welcome Admin', false, FailureHandling.OPTIONAL)
...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/b_Recruitment'), FailureHandling.STOP_ON_FAILURE)
